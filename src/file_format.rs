...
//! 0x24   56     col_offsets[7]         u64 each – absolute file offsets
//! 0x5C   56     col_lengths[7]         u64 each – byte lengths
//! 0x94    7     col_encodings[7]       u8 each
//! 0x9B    4     data_crc32             CRC32 over all column data bytes
//! 0x9F   97     padding
//! ──────  ────  Total = 256 bytes (0x100)
//! ```
//!
//! ## Column Layout (7 columns per segment)
//!
...
pub const NUM_TX_COLUMNS: usize = 7;
...
impl SegmentHeader {
    pub fn write_to<W: Write + Seek>(&self, w: &mut W) -> Result<()> {
        ...
        w.write_all(&[0u8; 97])?; // padding to 256
        Ok(())
    }
    ...
    pub fn read_from<R: Read>(r: &mut R) -> Result<Self> {
        ...
        // Note: caller handles magic validation contextually.
